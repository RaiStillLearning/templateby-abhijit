...
const PROJECTS = [
  {
    id: 1,
    name: "Projek Analisis Kanker Menggunakan Machine Learning",
    description: `Kami mengerjakan proyek analisis kanker
     menggunakan machine learning untuk mengklasifikasikan jenis kanker berdasarkan data medis.
     Proyek ini melibatkan pengumpulan data, pra-pemrosesan, pelatihan model, dan evaluasi hasil.
     Kami menggunakan algoritma seperti Decision Tree, Random Forest, dan Support Vector Machine untuk mencapai akurasi yang tinggi dalam klasifikasi kanker.
     Hasil dari proyek ini diharapkan dapat membantu dalam diagnosis dini dan pengobatan yang lebih efektif bagi pasien kanker.`,
    link: "https://projek-analisis-kanker.vercel.app/",
    images: ["/assets/project-dicoding/analisis-kanker.png"],
  },
  {
    id: 2,
    name: "financeme",
